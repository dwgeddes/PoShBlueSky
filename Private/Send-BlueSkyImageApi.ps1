function Send-BlueSkyImageApi {
    <#
    .SYNOPSIS
        Sends an image to BlueSky and returns the blob reference.
    .DESCRIPTION
...
Set-Alias -Name Upload-BlueSkyImageApi -Value Send-BlueSkyImageApi -Option AllScope
Export-ModuleMember -Function Send-BlueSkyImageApi -Alias Upload-BlueSkyImageApi
